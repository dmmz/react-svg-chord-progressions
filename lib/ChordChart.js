...
var ChordChart = function (_React$Component) {
    ...
    function ChordChart(props) {
        ...
        _this.svg.addObject(_ChordTexts2.default.getSvgElems(_this.bars, barView));
    ...
    _createClass(ChordChart, [{
        ...
        value: function barsRender() {
            ...
            barComponents.push((_barComponents$push = {
                x: 219, y: 100, width: 129 }, _defineProperty(_barComponents$push, 'y', 40), _defineProperty(_barComponents$push, 'attr', { fill: '#fff', 'fill-opacity': 0.5, stroke: '#f00', 'stroke-opacity': 1 }), _barComponents$push));
