...
var _getTimeSignature = require('./getTimeSignature');

var _getTimeSignature2 = _interopRequireDefault(_getTimeSignature);
...
var ChordProgression = function (_React$Component) {
    _inherits(ChordProgression, _React$Component);

    function ChordProgression(props) {
        _classCallCheck(this, ChordProgression);

        var _this = _possibleConstructorReturn(this, (ChordProgression.__proto__ || Object.getPrototypeOf(ChordProgression)).call(this, props));
        ...
        _this.bars = props.bars.map(function (bar, i) {
            return barView.setDimensions(bar, i);
        });
        ...
        _this.svg.addTexts((0, _getTimeSignature2.default)(_this.bars, barView));

        _this.barView = barView;
        return _this;
    }

    _createClass(ChordProgression, [{
        key: 'barsRender',
        ...
        value: function selectionsRender(selections) {
            ...
            return rects.map(function (props, i) {
                return _react2.default.createElement('rect', _extends({ key: i }, props));
            });
        }
    }, {
        key: 'render',
...
ChordProgression.propTypes = {
    width: _propTypes2.default.number.isRequired,
    bars: _propTypes2.default.array.isRequired,
    BarMouseUp: _propTypes2.default.func,
    BarMouseDown: _propTypes2.default.func,
    BarMouseOver: _propTypes2.default.func,
    colorSelected: _propTypes2.default.string,
    colorActive: _propTypes2.default.string,
    activeBar: _propTypes2.default.number,
    selectedBars: _propTypes2.default.array
};
exports.default = ChordProgression;