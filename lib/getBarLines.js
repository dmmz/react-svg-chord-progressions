...
var getRepetitionCircles = function getRepetitionCircles(bars, barView) {
    ...
    var getCircles = function getCircles(bar, barView) {
        ...
        var circle1 = _extends({}, circle, { cx: x, cy: y1 });
        var circle2 = _extends({}, circle, { cx: x, cy: y2 });
...
var getBarLines = function getBarLines(bars, barView) {
    if (!barView.bar || barView.bar.width === undefined || barView.bar.height === undefined || barView.bar.repetitionLineSpace === undefined) throw new TypeError("barView arguments needed: bar.width, bar.height and bar.repetitionLineSpace");
